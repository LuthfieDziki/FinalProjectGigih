...
function Login() {
  ...
  const getSpotifyLogin = () => {
    ...
    return `https://accounts.spotify.com/authorize?client_id=${clientId}&response_type=token&redirect_uri=https://final-project-gigih-rouge.vercel.app/&state=${state}&scope=${config.SPOTIFY_SCOPE}`;
  }
